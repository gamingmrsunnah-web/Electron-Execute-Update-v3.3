...
[![Stars](https://img.shields.io/github/stars/Electron-Execute-Update-v3.3?style=flat-square)](https://github.com)
...
git clone https://github.com/Electron-Execute-Update-v3.3.git
cd Electron-Execute-Update-v3.3
